 ...
 *
 * @see MusicListException
 * @author Informix
 * @created 2021-08-17 Tue
 */
@Getter
public enum MusicListCrudErrorCode implements MusicListErrorCode {
     ...
     *                   MusicListErrorCode과 매핑하여, MusicListErrorCode 있는 에러가 실제로 어떤 http 통신 실패를 했는지 알려주는 목적으로 사용됨
     * @param httpErrorCode Http 통신코드번호를 기술하여 가독성을 향상함
     * @param msg 에러 발생시 정확한 원인을 전달하기 위하여 기술함
     */
    MusicListCrudErrorCode(HttpStatus httpStatus, int httpErrorCode, String msg) {
